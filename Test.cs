...
namespace Buổi_3
{
    internal class Test
    {
        static void Main(string[] args)
        {
            ...
            //solve.Input("1/0");
            List<string> test = solve.ConvertInfix1("3√9 ^ 2");
    ...
    public class Solve1
    {
        ...
        //Các trường hợp check ra lỗi: chia cho 0; trong căn âm; giai thừa khác số nguyên;
        ...
        public string GetResult()
        {
            ...
            List<string> Postfix = ConvertInfix1(Infix);
        ...
        public static int Priority(char value)
        {
            switch (value)
            {
        ...
        public List<string> ConvertInfix1(string Infix)
        {
